...
import main.java.Utils.RetryAnalyser;
...
public class ListSuit implements ITestListener, IAnnotationTransformer {
    @Override
    ...
    public void onTestFailure(ITestResult iTestResult) {
        ...
        try{ FileUtils.copyFile (f, new File(fileName+".png"));
        }catch (IOException e ){
            e.printStackTrace();
        }
    }
